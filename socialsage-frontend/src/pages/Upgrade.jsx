...
export default function Upgrade() {
  ...
  const [selectedPlan, setSelectedPlan] = useState(2); // default Pro selected
          ...
          >
            ...
            >
              ...
              <button
                onClick={(e) => {
                  e.stopPropagation();
                  handleUpgrade("PRICE_STARTER_ID"); // TODO: replace with real Stripe price ID
                }}
                style={{
                  width: "100%",
                  background:
            ...
            >
              ...
              <button
                onClick={(e) => {
                  e.stopPropagation();
                  handleUpgrade("PRICE_PRO_ID"); // TODO: replace with real Stripe price ID
                }}
                style={{
                  width: "100%",
                  background:
