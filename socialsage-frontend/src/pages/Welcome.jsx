...
const Welcome = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center bg-gradient-to-tr from-gray-900 via-indigo-900 to-black overflow-hidden px-4">
      ...
      <div className="absolute top-10 right-10 w-80 h-80 bg-yellow-400/20 rounded-full blur-3xl"></div>
      <div className="absolute bottom-10 left-5 w-60 h-60 bg-pink-500/20 rounded-full blur-2xl"></div>
